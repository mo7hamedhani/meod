                                    ...
                                    <center><div id="errormsg"></div></center>
                                            ...
                                            <div class="row" style="margin-right: 0; margin-left:0;">
                                                <div class="col-md-6 country-col">
                                                    ...
                                                    <input type="text" class="form-control" name="cntry" id="state" autocomplete="address-level1"  value="<?php echo ip_info("Visitor", "Country");?>" data-parsley-trigger="focusout" disabled>
                                                </div>
                                                <div class="col-md-6">
